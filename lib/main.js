...
(function() {
  ...
  Button = (function(_super) {
    ...
    function Button(gamepad, num) {
      ...
      if (isFinite(gamepad.buttons[0])) {
        _value = function() {
          return Boolean(gamepad.buttons[num]);
        };
      } else {
        _value = function() {
  ...
  GamepadMap = (function() {
    ...
    GamepadMap.platform = "linux";

    GamepadMap.activeMap = null;
  ...
  Gamepads = (function(_super) {
    var _reQueue, _support, _webkitStyle;
    ...
    function Gamepads() {
      var gamepads, _getPad, _registered;
      gamepads = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
      if (typeof navigator === "undefined" || navigator === null) {
        throwError("Navigator not exists! Browser strange.");
        return;
      }
      if ((navigator.getGamepads == null) && (navigator.webkitGetGamepads == null)) {
        throwError("Gamepad API not yet.");
        return;
      }
          ...
          return function() {
            ...
            for (_i = 0, _len = _registered.length; _i < _len; _i++) {
              ...
              if (gamepad.connected) {
                ...
                if (!pad3) {
                  throwError("Logic: gamepad registered not created or replaced");
                  return;
                }
                pad3.connect();
    ...
    Gamepads.prototype._gamepadDisconnect = function(gamepad) {
      ...
      if (!ids) {
        throwError("Disconect unregistered gamepad. After init should be call `detect` method.");
        return;
      }
      ...
      if (pad2 == null) {
        throwError("Critical: registred and not created gamepad!");
        return;
      }
      pad2.disconnect();
      ...
      requestAnimationFrame((function(_this) {
        return function() {
          ...
          startTimers = function() {
            ...
            if (_webkitStyle && t2 === null) {
              t2 = tick(100, function() {
                var fn, _i, _len;
