...
(function() {
   ...
   */
  var Axis, Block, Button, EventTargetEmiter, EventedArray, Gamepad2, GamepadMap, Gamepads, SPoke, isFunction, isString, merge, messages, overlay, silent, skip, start, stopTick, throwError, throwInfo, throwWarn, tick, top, wait, _implements,
    __slice = [].slice,
  ...
  Gamepad2 = (function(_super) {
    ...
    Gamepad2.prototype.reMap = function(map) {
      var block, blockName, _ref, _results;
      ...
      for (blockName in _ref) {
        ...
        if ((blockName in this) || this.config.allowCustomBlockName === true) {
          if (this[blockName] === null) {
            _results.push(associate(this, this.config.naming, blockName, block));
          } else {
            _results.push(this[blockName].reSubscribe(this.gamepad));
          }
        } else {
    ...
    parseId = function(id) {
      ...
      if (moz.test(id)) {
        ...
        return id.match(webkit);
      } else if (other.test(id)) {
        return id.match(other);
      } else {
        return [null, "0000", "0000"];
      }
    };
