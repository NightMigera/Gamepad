...
(function() {
   ...
   */
  var Axis, Block, Button, EventTargetEmiter, EventedArray, Gamepad2, GamepadMap, Gamepads, SPoke, createEvent, isFunction, isString, merge, messages, overlay, silent, skip, start, stopTick, throwError, throwInfo, throwWarn, tick, top, wait, zeroFill, _implements,
    __slice = [].slice,
  ...
  EventTargetEmiter = (function() {
    ...
    EventTargetEmiter.prototype.parent = null;
    ...
    EventTargetEmiter.prototype.on = function() {
      var args;
    ...
    EventTargetEmiter.prototype.off = function() {
      var args;
      args = 1 <= arguments.length ? __slice.call(arguments, 0) : [];
    ...
    EventTargetEmiter.prototype.emet = function(name, evt) {
      ...
      if ((evt != null ? evt.bubbles : void 0) === true) {
        try {
          this.parent.emet(name, evt);
        } catch (_error) {}
      }
      if (evt != null) {
  ...
  SPoke = (function() {
    ...
    SPoke.prototype.s = function(action, listen) {
      if (listen == null) {
        listen = null;
      }
      if (listen == null) {
        return (action in this._subscribe && (this._subscribe[action].listen === true || this._subscribe[action].length > 0)) || (this["on" + action] != null);
      } else {
        if (action in this._subscribe) {
          return this._subscribe[action].listen = listen;
        } else {
          return false;
        }
      }
  ...
  Axis = (function(_super) {
    ...
    function Axis(gamepad, num, mode, name, positive, triggerValue) {
      var r, _value;
      this.name = name;
      ...
      if (this._subscribe._length > 0) {
        if (this.s('change')) {
          if (this._oldValue !== (v = this.value)) {
            this.emet('change', createEvent('change', {
              target: this,
  ...
  Button = (function(_super) {
    ...
    function Button(gamepad, num, name, asAxis) {
      var _value, _webkit;
      this.name = name;
      if (asAxis == null) {
        asAxis = false;
  ...
  Block = (function(_super) {
    ...
    function Block(map, gamepad, name) {
      this.name = name;
    ...
    Block.prototype._mapParse = function(map) {
      ...
      for (name in map) {
        ...
        if (val.hasOwnProperty('axis') && (val.axis != null)) {
          axis = new Axis(this.gamepad, val.axis, val.mode || AS_STICK, name, Boolean(val.positive), val.triggerValue || 0);
          if ('onchange' in axis) {
            this[name] = axis;
            axis.parent = this;
          } else {
          ...
          button = new Button(this.gamepad, val.button, name, val.asAxis);
    ...
    Block.prototype.removeEventListener = function(type) {
      var name, _ref;
      Block.__super__.removeEventListener.apply(this, arguments);
      if (type === 'change' && this._subscribe.change.length === 0) {
        _ref = this.map;
        for (name in _ref) {
          if (!__hasProp.call(_ref, name)) continue;
          this[name].s('change', false);
        }
      }
    };
  ...
  Gamepad2 = (function(_super) {
    ...
    Gamepad2.prototype.addEventListener = function(type) {
      var name, _ref;
      if (type === 'change' && !this.s('change')) {
        _ref = this.map.activeMap;
        for (name in _ref) {
      ...
      return Gamepad2.__super__.addEventListener.apply(this, arguments);
    };
